...
class Locales {
  ...
  static const fr = {
    'AppName': 'Terre Xlife',
    'SignInTitle': 'Connectez-vous à Fenua Xlife',
    'SignupTitle': 'Rejoignez Fenua Xlife',
    ...
    'WeHaveSentOTP':
        'Nous avons envoyé un code OTP à votre numéro de téléphone, veuillez entrer ce code ci-dessous pour vérifier.',
    'HaventReceivedCode': 'N\'ont pas encore reçu de code?',
    ...
    'Year': 'An',
    'RelevantEducationDetails':
        'Ajouter des détails de l\'éducation pertinents',
    'FullRelevantEducationDetails':
        'Ajoutez des détails d\'éducation pertinents qui aideront les clients à mieux vous connaître.',
    ...
    'term1':
        'J\'accepte de recevoir des offres commerciales des concours Fenua - 100% gratuit et ses partenaires',
    'term2':
    ...
    'Youinvestedtickets': 'Vous avez investi 1 tickets',
    ...
    'Congrats1ticketaddedforyou': 'Félicitations - 1 ticket ajouté pour vous',
    'morechance': '1 ticket = 1 chance de plus',
    'Wallet': 'Porte monnaie',
    'Winmoretickets': 'Gagner plus de tickets',
    'Clickthebuttonbelowtowatchvideoadandearnmoretickets':
        'Cliquez sur le bouton ci-dessous pour regarder une annonce vidéo et gagner plus de tickets',
    'Earnticket': 'Gagnez 1 ticket',
    'Youalreadyhaveinyouraccountbalance':
        'Vous avez déjà 1 dans votre solde de votre compte. Vous pouvez les utiliser ou regarder plus d\'annonces pour gagner plus de tickets',
    ...
    'Invested1ticket': 'Investi 1 ticket',
    ...
    'From': 'Depuis',
    'SelectAttachmentOption': 'Sélectionnez l\'option de fixation',
    ...
    'ApplyAsOrganizer': 'Appliquer comme organisateur',
    'SendRequestEmailToAdmin':
        'Envoyer une demande de courrier électronique à admin pour être organisateur. Une fois la demande acceptée, vous serez informé',
    'EmailCopied': 'Email copié',
    'NoResults': 'Aucun résultat',
    'SearchEvent': 'Événement de recherche',
    'Filter': 'Filtre',
    'LikedEvents': 'A aimé des événements',
